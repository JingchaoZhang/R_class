...
def process_data(data):
  ...
  #print("The {} had the most sales: {}".format(car_model, max_sale))
  d = {}
  for item in data:
    d[item['car']['car_year']] = d.get(item['car']['car_year'], 0) + item["total_sales"]
  ...
  summary = [
    ...
    "The {} {} ({})had the most sales: {}".format(car_make, car_model, car_year, max_sale),
    "The most popular year was {} with {} sales.".format(maxy, maxs)
  ]
